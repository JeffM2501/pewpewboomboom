...
function check_raylib()
    if(os.isdir("raylib") == false and os.isdir("raylib-master") == false) then
        if(not os.isfile("raylib-master.zip")) then
            ...
            local result_str, response_code = http.download("https://github.com/JeffM2501/raylibEx/archive/refs/heads/master.zip", "raylib-master.zip", {
        ...
        os.rename("raylibEX-master", "raylib-master")
    end
end
